<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('login_pin')); ?>:</b>
	<?php echo CHtml::encode($data->login_pin); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('security_question2')); ?>:</b>
	<?php echo CHtml::encode($data->security_question2); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('security_answer2')); ?>:</b>
	<?php echo CHtml::encode($data->security_answer2); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('ecurrency')); ?>:</b>
	<?php echo CHtml::encode($data->ecurrency); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('ecurrency_purse')); ?>:</b>
